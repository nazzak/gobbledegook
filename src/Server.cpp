...
#pragma GCC diagnostic ignored "-Wunused-parameter"
				   ...
				   GGKServerDataGetter getter, GGKServerDataSetter setter)
	{
		...
		objects.back()
			...
			.onEvent(
				1, nullptr, CHARACTERISTIC_EVENT_CALLBACK_LAMBDA {
			...
			.gattServiceBegin("barcode", "00000009-1E3C-FAD4-74E2-97A033F1BFAA")

			// Characteristic: String value (custom: 00000002-1E3C-FAD4-74E2-97A033F1BFAA)
			.gattCharacteristicBegin("string", "00000009-1E3C-FAD4-74E2-97A033F1BFAA", {"read", "notify"})

			// Standard characteristic "ReadValue" method call
			.onReadValue(CHARACTERISTIC_METHOD_CALLBACK_LAMBDA {
				const char *pTextString = self.getDataPointer<const char *>("barcode/string", "");
			...
			.onReadValue(DESCRIPTOR_METHOD_CALLBACK_LAMBDA {
				const char *pDescription = "A barcode reader characteristic";
